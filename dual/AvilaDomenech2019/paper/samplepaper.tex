...
Dual watermarking implies embedding of robust as well as fragile watermarks into the same cover image. It facilitates integration of copyright protection and integrity verification into the same scheme. First robust watermarking and then the fragile watermarking should be done because the fragile watermarking is sensitive to small changes. Unlike the fragile watermarking, resists changes caused by performing the marked fragile.
\begin{figure}
	\begin{center}
...
\begin{enumerate}
	...
	\item Realize the YCbCr to RGB conversion to obtain RGB watermarked image.
\end{enumerate}
