...
\begin{figure}
	\begin{center}
		...
		\caption{Comportamiento del BER al marcar la imagen x de Saint Gall database con marcas de aguas de distintos tamaños.} \label{berwsizeSaintGall}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=\textwidth]{BERwsizeParzival.eps}
		\caption{Comportamiento del BER al marcar la imagen x de Parzival database con marcas de aguas de distintos tamaños..} \label{berwsizeParzival}
	\end{center}
\end{figure}
