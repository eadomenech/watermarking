...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{PSNRwsize.eps}
		\caption{PSNR W Size.} \label{psnrwsize}
	\end{center}
\end{figure}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=\textwidth]{BERwsize.eps}
		\caption{BER W Size.} \label{berwsize}
	\end{center}
\end{figure}
