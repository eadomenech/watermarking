...
from Shivani2017Ra import Shivani2017Ra
...
def run_main():
    ...
    for w_size in size_to_evaluate:
        # Instancias
        wmr = Shivani2017Ra(watermark.resize((w_size, w_size)))
        wmf = Shivani2017F('password')
        ...
        watermarked_image_without_noise.save(
            "static/experimento/watermarked_" + name + str(w_size) + "_without_noise.png")
        ...
        watermarked_image_without_noise.save(
            "static/experimento/watermarked_" + name + str(w_size) +  "_with_jpeg25.jpg",
            quality=25, optimice=True)
        watermarked_image_without_noise.save(
            "static/experimento/watermarked_" + name + str(w_size) +  "_with_jpeg50.jpg",
            quality=50, optimice=True)
        watermarked_image_without_noise.save(
            "static/experimento/watermarked_" + name + str(w_size) +  "_with_jpeg75.jpg",
        ...
        watermark_extracted.save(
            "static/experimento/watermark_" + name + str(w_size) +  "_without_noise.png")

        print("Calculando BER without noise")
        # Cargando watermark
        watermark = Image.open(
            "static/Watermarking.png"
            ).resize((w_size, w_size)).convert("1")
        ...
        watermark_extracted.save(
            "static/experimento/watermark_" + name + str(w_size) +  "_with_jpeg25.png")
        ...
        watermark_extracted.save(
            "static/experimento/watermark_" + name + str(w_size) +  "_with_jpeg50.png")
        ...
        watermark_extracted.save(
            "static/experimento/watermark_" + name + str(w_size) +  "_with_jpeg75.png")
